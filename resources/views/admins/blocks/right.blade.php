                                ...
                                <div class="content">
                                    ...
                                    <div class="contact-list contact-list-recent">
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('assets/admins/img/avatar1.png') }}
                                                    " alt="Avatar">
                                        ...
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('assets/admins/img/avatar2.png') }}
                                                    " alt="Avatar">
                                        ...
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('assets/admins/img/avatar3.png') }}
                                                    " alt="Avatar">
                                    ...
                                    <div class="contact-list">
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('assets/admins/img/avatar4.png') }}
                                                    " alt="Avatar">
                                                <div class="user-data2"><span class="status"></span><span
                                                        class="name">Mike Bolthort</span></div>
                                            </a></div>
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('assets/admins/img/avatar5.png') }}
                                                    " alt="Avatar">
                                                <div class="user-data2"><span class="status"></span><span
                                                        class="name">Maggie jackson</span></div>
                                            </a></div>
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('assets/admins/img/avatar6.png') }}
                                                    " alt="Avatar">
