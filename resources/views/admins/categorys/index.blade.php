    ...
    <div class="be-content">
        <div class="row">
            <div class="page-head col">
                <h2 class="page-head-title">Loại giày</h2>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        <li class="breadcrumb-item"><a href="#">Quản lý sản phẩm</a></li>
                        <li class="breadcrumb-item active">Loại giày</li>
                    </ol>
                </nav>
            </div>
            <div class="col-4 p-3">
                                            ...
                                            <div class="modal-content">
                                                <form action="{{ route('category.store') }}" id="FormLoad" method="post">
                                                    ...
                                                    <div class="modal-header d-block">
                                                        <h3 class="modal-title text-center">Thêm mới loại giày</h3>
                                                    </div>
                                                    <!-- Modal body -->
                                                    <div class="modal-body">
                                                        <div class="">
                                                            <div class="form-group row mt-2">
                                                                <div class="col">
                                                                    <input class="form-control @error('name') is-invalid @enderror" name="name" id="name" type="text" placeholder="Tên loại giày">
                                                                    @error('name')
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <div class="text-center">
                                                ...
                                                <h3>Thông báo!</h3>
                                                <p>Bạn có chắc muốn xóa những loại giày được chọn!</p>
                                                <div class="mt-8">
                                    ...
                                    @foreach ($categorys as $key=>$category)
                                        <tr class="odd gradeX">
                                            <td data-status="in-progress">
                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                    <input class="custom-control-input allItem" type="checkbox" id="{{$category->id}}" value="{{$category->id}}">
                                                    <label class="custom-control-label labelItem" for="{{$category->id}}"></label>
                                                </div>
                                            </td>
                                            <td>{{$key+1}}</td>
                                            <td>{{$category->name}}</td>
                                            ...
                                            <td>
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="{{ route('category.destroy',$category->id) }}" method="POST">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="text-danger"><span class="modal-main-icon mdi mdi-close-circle-o"></span></div>
                                                                    <h3>Thông báo!</h3>
                                                                    <p>Bạn có chắc muốn xóa loại giày: {{$category->name}}!</p>
                                                                    <div class="mt-8">
                                                ...
                                                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#Modal{{$category->id}}">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="{{ route('category.update',$category->id) }}" method="post">
                                                                ...
                                                                @method('PUT')
                                                                <div class="modal-header d-block">
                                                                    <h3 class="text-center"><strong>Loại giày</strong></h3>
                                                                </div>
                                                                <div class="modal-body">
