    ...
    <div class="be-content">
        <div class="row">
            <div class="page-head col">
                <h2 class="page-head-title">Đế giày</h2>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb page-head-nav">
                        <li class="breadcrumb-item"><a href="#">Quản lý sản phẩm</a></li>
                        <li class="breadcrumb-item active">Đế giày</li>
                    </ol>
                </nav>
            </div>
            <div class="col-4 p-3">
                    ...
                    <div class="card card-table">
                                            ...
                                            <div class="modal-content">
                                                <form action="{{ route('sole.store') }}" id="FormLoad" method="post">
                                                    ...
                                                    <div class="modal-header d-block">
                                                        <h3 class="modal-title text-center">Thêm mới đế giày</h3>
                                                    </div>
                                                    <!-- Modal body -->
                                                    <div class="modal-body">
                                                        <div class="">
                                                            <div class="form-group row mt-2">
                                                                <div class="col">
                                                                    <input class="form-control @error('name') is-invalid @enderror" name="name" id="name" type="text" placeholder="Tên đế giày">
                                                                    @error('name')
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a type="button" class="btn btn-danger text-light" data-bs-dismiss="modal">Hủy</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <div class="text-center">
                                                ...
                                                <h3>Thông báo!</h3>
                                                <p>Bạn có chắc muốn xóa những đế giày được chọn!</p>
                                                <div class="mt-8">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-hover table-fw-widget text-center" id="table1">
                                ...
                                <tbody>
                                    @foreach ($soles as $key=>$sole)
                                        <tr class="odd gradeX">
                                            <td data-status="in-progress">
                                                <div class="custom-control custom-control-sm custom-checkbox">
                                                    <input class="custom-control-input allItem" type="checkbox" id="{{$sole->id}}" value="{{$sole->id}}">
                                                    <label class="custom-control-label labelItem" for="{{$sole->id}}"></label>
                                                </div>
                                            </td>
                                            <td>{{$key+1}}</td>
                                            <td>{{$sole->name}}</td>
                                            <td>{{$sole->date_create}}</td>
                                            <td>
                                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#Delete{{$sole->id}}" type="submit">
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="{{ route('sole.destroy',$sole->id) }}" method="POST">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="text-danger"><span class="modal-main-icon mdi mdi-close-circle-o"></span></div>
                                                                    <h3>Thông báo!</h3>
                                                                    <p>Bạn có chắc muốn xóa đế giày: {{$sole->name}}!</p>
                                                                    <div class="mt-8">
                                                ...
                                                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#Modal{{$sole->id}}">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="{{ route('sole.update',$sole->id) }}" method="post">
                                                                ...
                                                                @method('PUT')
                                                                <div class="modal-header d-block">
                                                                    <h3 class="text-center"><strong>Đế giày</strong></h3>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label for="">Tên đế</label>
                                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $sole->name }}">
                                                                    @error('name')
