    ...
    <div class="be-content">
        <div class="row">
            <div class="page-head col">
                <h2 class="page-head-title">Chất liệu</h2>
                                            ...
                                            <div class="modal-content">
                                                <form action="{{ route('material.store') }}" id="FormLoad" method="post">
                                                    ...
                                                    <div class="modal-header d-block">
                                                        <h3 class="modal-title text-center">Thêm mới chất liệu</h3>
                                                    </div>
                                                    <!-- Modal body -->
                                                    <div class="modal-body">
                                                        <div class="">
                                                            <div class="form-group row mt-2">
                                                                <div class="col">
                                                                    <input class="form-control @error('name') is-invalid @enderror" name="name" id="name" type="text" placeholder="Tên chất liệu">
                                                                    @error('name')
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <div class="text-center">
                                                ...
                                                <h3>Thông báo!</h3>
                                                <p>Bạn có chắc muốn xóa những Chất liệu được chọn!</p>
                                                <div class="mt-8">
                                ...
                                <tbody>
                                    @foreach ($materials as $key=>$material)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#Delete{{$material->id}}" type="submit">
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="{{ route('material.destroy',$material->id) }}" method="POST">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="text-danger"><span class="modal-main-icon mdi mdi-close-circle-o"></span></div>
                                                                    <h3>Thông báo!</h3>
                                                                    <p>Bạn có chắc muốn xóa Chất liệu: {{$material->name}}!</p>
                                                                    <div class="mt-8">
                                                ...
                                                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#Modal{{$material->id}}">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="{{ route('material.update',$material->id) }}" method="post">
                                                                ...
                                                                @method('PUT')
                                                                <div class="modal-header d-block">
                                                                    <h3 class="text-center"><strong>Chất liệu</strong></h3>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label for="">Tên chất liệu</label>
                                                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $material->name }}">
                                                                    @error('name')
