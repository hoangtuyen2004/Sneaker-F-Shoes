                                                ...
                                                <div class="color row m-0 p-0">
                                                    <div class="color-item col p-0">
                                                        @foreach ($product->attribute->groupBy('colors.color_code') as $key => $attributes)
                                                            <div class="item">
                                                                <label onclick="checkColor($i,$key)" id="color-{{$i}}-{{$key}}" style="background-color:{{$key}};" class="labelColor" for="color_id-{{$i}}-{{$key}}">
                                                                    <i style="display: none;" class="fa-solid fa-check"></i>
                                                                </label>
                                                                <input type="radio" name="color_code" id="color_id-{{$i}}-{{$key}}" value="{{$key}}">
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <div class="size row m-0 p-0">
                                                    <div class="size-item col p-0">
                                                        @foreach ($product->attribute->groupBy('sizes.size_code') as $key => $attributes)
                                                            <div class="item">
                                                                <label onclick="checkSize($i,$key)" class="labelsize" for="size_id-{{$i}}-{{$key}}">{{$key}}</label>
                                                                <input type="radio" name="size_code" id="size_id-{{$i}}-{{$key}}" value="{{$key}}">
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
